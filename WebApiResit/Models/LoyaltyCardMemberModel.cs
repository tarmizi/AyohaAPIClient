...
{
    public class LoyaltyCardMemberModel
    {
        ...
        public string LoyaltyCardMemberRequestDate
        {
            get;
            set;
        }
        public string LoyaltyCardMemberByMethod
        {
            get;
            set;
        }
         public string LoyaltyCardMemberApprovalDate
        {
            get;
            set;
        }

        public string LoyaltyCardMemberApprovalBy
        {
            get;
            set;
        }
        public string ReferalSubscriberAccNo
        {
         ...
         public string LoyaltyCardMemberFee
        {
            get;
            set;
        }
        ...
        public string RowStatus
        {
         ...
         public string LoyaltyCardMemberNo
        {
            get;
            set;
        }

        public string LoyaltyCardMemberApprovalStatus
        {
            get;
            set;
        }
        ...
        public LoyaltyCardMemberModel() { }


        public static List<LoyaltyCardMemberModel> LoyaltyCardMember_LoadBySubscriberAccNo(string SubscriberAccNo)
        {
            List<LoyaltyCardMemberModel> _Value = new List<LoyaltyCardMemberModel>();
            ...
            using (SqlConnection _DBConnection = _SQLConnection)
            {
                ...
                using (_SQLCommand)
                {
                    try
                    {
                        ...
                        _SQLCommand.CommandText = "LoyaltyCardMember_LoadBySubscriberAccNo";
                        _SQLCommand.Parameters.AddWithValue("@SubscriberAccNo", SubscriberAccNo);
                        _DBConnection.Open();
                        SqlDataReader _SQLDataReader = _SQLCommand.ExecuteReader();
                        LoyaltyCardMemberModel _result;
                        while (_SQLDataReader.Read())
                        {
                            _result = new LoyaltyCardMemberModel();
                            _result.ID = Convert.ToInt32(_SQLDataReader["ID"].ToString());
                            _result.LoyaltyCardMemberNo = _SQLDataReader["LoyaltyCardMemberNo"].ToString();

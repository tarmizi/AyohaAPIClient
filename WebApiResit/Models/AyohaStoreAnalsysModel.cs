...
{
    public class AyohaStoreAnalsysModel
    {
         public int ID
        {
            get;
        ...
        public AyohaStoreAnalsysModel() { }




        public static string AyohaStoreAnalsys_InsertUpdate(string SubscriberAccNo, string IPAddress,
string EnterpriseAccNo, string AccessedPlatform)
        {
            ...
            using (SqlConnection _DBConnection = _SQLConnection)
            {
                ...
                using (_SQLCommand)
                {
                    try
                    {
                        ...
                        _SQLCommand.CommandText = "AyohaStoreAnalsys_InsertUpdate";

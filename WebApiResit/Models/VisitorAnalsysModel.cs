...
{
    public class VisitorAnalsysModel
    {
        public int ID
        {
            get;
        ...
        public VisitorAnalsysModel() { }


        public static string VisitorAnalsys_InsertUpdate(string SubscriberAccNo, string IPAddress,
 string EnterpriseAccNo, string AdvertisementCode, string AccessedPlatform,string Module)
        {
            ...
            using (SqlConnection _DBConnection = _SQLConnection)
            {
                ...
                using (_SQLCommand)
                {
                    try
                    {
                        ...
                        _SQLCommand.CommandText = "VisitorAnalsys_InsertUpdate";
